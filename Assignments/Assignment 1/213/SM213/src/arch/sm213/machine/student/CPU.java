  ...
  @Override protected void execute () throws InvalidInstructionException, MachineHaltException, RegisterSet.InvalidRegisterNumberException, MainMemory.InvalidAddressException
  {
    ...
    switch (insOpCode.get()) {
      ...
      case 0x1: // ld o(rs), rd .......... 1psd  (p = o / 4)
          ...
          rd = insOp2.get();
          ri = insOp0.get();
          address = mem.readInteger((ri * 4) + reg.get(rs));
          reg.set(rd,address);
          break;
      case 0x2: // ld (rs, ri, 4), rd .... 2sid
          ...
          rd = insOp2.get();
          rs = insOp0.get();
          address = mem.readIntegerUnaligned((reg.get(ri) * 4) + reg.get(rs));
          reg.set(rd,address);
        break;
      case 0x3: // st rs, o(rd) .......... 3spd  (p = o / 4)
          ...
          ri = insOp1.get();
          rd = insOp2.get();
          address = (ri * 4) + reg.get(rd);
          mem.writeInteger(address,reg.get(rs));
        break;
      case 0x4: // st rs, (rd, ri, 4) .... 4sdi
          rs = insOp0.get();
          rd = insOp1.get();
          ri = insOp2.get();
          address = reg.get(rd) + (reg.get(ri) * 4);
          mem.writeInteger(address,reg.get(rs));
        break;
      case 0x6: // ALU ................... 6-sd
	switch (insOp0.get()) {
	  ...
	  case 0x1: // add rs, rd ........ 61sd
            rs = insOp1.get();
          rd = insOp2.get();
          reg.set(rd, reg.get(rd) + reg.get(rs));
	    break;
	  ...
	  case 0x3: // inc rr ............ 63-r
            rd = insOp2.get();
          reg.set(rd, reg.get(rd) + 1);
	    break;
	  case 0x4: // inca rr ........... 64-r
          rd = insOp2.get();
          reg.set(rd, reg.get(rd) + 4);
	    break;
	  ...
	  case 0x7: // not ............... 67-r
	    ...
	    break;
        case 0xf: // gpc $o, rd............pd
            rd = insOp2.get();
            reg.set(rd, pc.get() + insOp1.get() * 2);
            break;
	  default:
	...
	break;
      case 0x7: // sh? $i,rd ............. 7dii
        rd = insOp0.get();
          address = insOpImm.get();

          // POSITIVE CASE
          if(address > 0)
              reg.set(rd, reg.get(rd) << address);
